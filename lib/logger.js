...
(function (module) {
    ...
    function connect(properties) {
        ...
        console_log("logging region and bucket", region, bucket);
        ...
        return {
            ...
            hostname:encodeURIComponent(properties.hostname || os.hostname()),
            bucket:bucket,
